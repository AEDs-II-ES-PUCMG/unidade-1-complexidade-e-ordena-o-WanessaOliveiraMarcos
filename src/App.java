...
public class App {
    ...
    static Pedido[] copiaProdutosOrdenadosPorValor;
    ...
    */
    ...
    static void localizarPedidosPremium() {
        ...
        listarPedidosPremium(valorCorte);
    ...
    */
    ...
    static void listarTodosOsPedidos() {
     ...
     static void listarPedidosPremium(double valor) {
    	
        cabecalho();
        System.out.println("\nPedidos cadastrados: ");
        for (int i = 0; i < quantPedidos; i++) {
            if(copiaProdutosOrdenadosPorValor[i].valorFinal() >= valor){
                break;
            }
        	System.out.println(String.format("%02d - %s\n", (i + 1), copiaProdutosOrdenadosPorValor[i].toString()));
        }
    }
    public static void main(String[] args) {
    	...
    	nomeArquivoDados = "src/produtos.txt";
        produtosCadastrados = lerProdutos(nomeArquivoDados);
       
        String nomeArquivoPedidos = "src/pedidos.txt";
        ...
        ordenador.setComparador(new ComparadorPorValor());  
         copiaProdutosOrdenadosPorValor = ordenador.ordenar(pedidosCadastrados);
